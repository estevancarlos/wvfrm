(function($) {
	...
	$(document).ready(function() {
		...
		if($("#wpexNewsletterYesBtn").length > 0) {
			$("#wpexNewsletterYesBtn").click(function() {
				$("#wpexNewsletterFrm").show().next().hide();
			});
			$("#wpexNewsletterFrm").submit(function() {
				$("#wpexNewsletterNoBtn").click();
			});
		}
	...
	wpexHideSaleNag = function(ev, nagId){
		var data = {
